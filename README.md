...
<p align="center">
  <img src="https://github.com/tanevnik/Millionaire/blob/master/Millionaire/Resources/logo.png?raw=true" height="300" width="300">
</p>
...
Прашањата се централната точка во оваа игра. Базата на прашања содржи над 300 прашања кои се сместени во .txt фајл каде тие се структурирани во одреден формат за нивно лесно читање. Има 15 нивоа на прашања сортирани по тежина и секое ниво соодветствува на бројот на прикажаното прашање. 
...
Елементите во прашањето се споени со знакот „~“ за нивна полесна сепарација. Откако ќе се прочитаат сите прашања од оваа датотека, тие се чуваат во класата Model во листа од објекти од помошната класа Question.
